...
## 2) Extract only  mean and std deviation for each measurement. 
...
## 5) Construct a tidy data set with the average of each variable for each activity and each subject. 
